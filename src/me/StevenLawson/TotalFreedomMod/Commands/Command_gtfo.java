...
@CommandParameters(description = "Makes someone GTFO (deop and ip ban by username) (24 hours).", usage = "/<command> <partialname>")
public class Command_gtfo extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.bcastMsg(player.getName() + " has been a VERY naughty, naughty OP.", ChatColor.RED);
