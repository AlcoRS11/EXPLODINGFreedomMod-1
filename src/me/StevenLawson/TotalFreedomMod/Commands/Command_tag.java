...
public class Command_tag extends TFM_Command
{
    ...
    {
        "admin", "owner", "moderator", "developer", "console", "mod", "super admin", "senior admin", "telnet admin", "system admin", "server", "co owner", "fo founder", "founder", "system owner", "system coowner", "system-owner", "system-coowner", "executive", "cheif of security"
    });
